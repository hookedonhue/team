...
const HOH = {
  ...
  cos: {
    ...
    what: 'Not a department head — an extension of the founder\'s capacity to lead. Sits beside Dorian, not below him. While the four Chiefs run the business, the Chief of Staff runs the CEO. Every week starts here.',
    capabilities: [
  ...
  chiefs: [
    {
      ...
      what: 'The editorial director of HoH. Doesn\'t write — orchestrates. Makes sure every content agent works in concert toward the same publishing goals. Runs the content engine so Dorian can focus on the ideas.',
      capabilities: [
